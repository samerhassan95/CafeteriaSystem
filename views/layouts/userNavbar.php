...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active fs-5" aria-current="page" href="/CafeteriaSystem/views/user/userPage.php">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fs-5" href="/CafeteriaSystem/views/user/userOrders.php">My Orders</a>
                </li>
<!--                <li class="nav-item">-->
