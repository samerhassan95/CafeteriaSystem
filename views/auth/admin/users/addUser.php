...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../../../../public/styles/addUser.css">
      </head>
    <body>
      <div class="container">
        <form action="../../../../controllers/admin/addUserValid.php" method="post" enctype="multipart/form-data" style="margin: auto;">
          ...
          <div class="form-row">
           ...
           <input type="password" class="form-control" name="confirm" placeholder="confirm password" required/>
              ...
              <div class="input-group mt-2">
                ...
                <input type="number" class="form-control" name="ext_attr" placeholder="Exit">
              </div>
