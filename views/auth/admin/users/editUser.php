...
<body>
  <div class="container">
    <form action="../../../../controllers/admin/update.php?id=<?php echo $row['id'] ?>" method="post" enctype="multipart/form-data" style="margin: auto;">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-lg-6">
          <div class="input-group mt-2">
            ...
            <input type="text" class="form-control" name="ext_attr" placeholder="Ext" value="<?php echo $row['ext_attr']; ?>">
          </div>
