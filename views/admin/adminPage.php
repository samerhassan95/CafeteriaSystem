...
" class="col-12 col-md-4 d-flex flex-column justify-content-between border border-1 rounded-start border-dark">
        ...
        <div class="col-12 col-md-8 rounded-end" style="background-color: #e1e1e1;">

            <select class="form-select my-5" name="user_id" id="UserSelection">
...
<script>
    ...
    function sendOrder() {
        ...
        var orderDetails = {
            user_id: document.getElementById("UserSelection").value,
