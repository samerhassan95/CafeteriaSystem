...
<head>
    ...
    <link rel="stylesheet" href="/CafeteriaSystem/public/styles/addUser.css">
</head>
<body>
<div class="container">
    <form action="/CafeteriaSystem/controllers/admin/userActions/addUserValid.php?method=add" method="post"
        ...
        <div class="form-row">
            <div class="form-group col-lg-6">
                ...
                <span class="input-group-prepend input-group-text">
                    ...
                    <input type="text" class="form-control" name="username" placeholder="Name" value="<?php if (isset($old_data['username'])) echo $old_data['username']; ?>">
                </div>
