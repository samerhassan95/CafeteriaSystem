...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid ">
      <a class="navbar-brand" href="#">
        <img class="nav-logo" src="../public/images/logo4.png" alt="Logo">
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-md-auto gap-2 justify-content-center">
          <li class="nav-item dropdown rounded">
            <a class="nav-link1 nav-link" href="./home.php"><i class="bi bi-house-fill me-2"></i>Home</a>
          </li>
          <li class="nav-item dropdown rounded">
            <a class="nav-link2 nav-link" href=""><i class="bi bi-card-image me-2"></i>Products</a>
          </li>
          <li class="nav-item dropdown rounded">
            <a class="nav-link3 nav-link" href="./admin/displayUsers.php" id="shopDropdown" ><i class="bi bi-cart4 me-2"></i>Users</a>
          </li>
          <li class="nav-item dropdown rounded">
